...
>(({ className, variant, ...props }, ref) => {
  return (
    ...
    >
      {props.children}
      {/* Added explicit ToastClose here so every toast has an X button */}
      <ToastClose />
    </ToastPrimitives.Root>
  );
});
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      // Changed opacity-0 to opacity-100 to make it always visible, or keep opacity-0 and group-hover:opacity-100 for hover effect
